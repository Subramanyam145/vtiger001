...
public class ReadDataFromDatabase {
	...
	public static void main(String[] args)  throws SQLException {
		//Step 1: Create an instance of JDBC Driver
				...
				ResultSet result = statement.executeQuery("desc employees");
				
				while(result.next()) {
					System.out.println(result.getString("Field")+"\t"+result.getString("name")+"\t"+result.getInt("salary")+"\t"+result.getString("phone"));
					}
